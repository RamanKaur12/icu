            ...
            <div class="col-2">
                ...
                <div class="social-link">
                    <div class="social-icons">
                            <a href="<?php the_field('facebook_link_general', 'options'); ?>" target="blank"><img src="<?php the_field('facebook_icon_general', 'options'); ?>" alt=""></a>
                            <a href="<?php the_field('twitter_link_general', 'options'); ?>" target="blank"><img src="<?php the_field('twitter_icon_general', 'options'); ?>" alt=""></a>
                            <a href="<?php the_field('linklnd_link_general', 'options'); ?>" target="blank"><img src="<?php the_field('linkldn_icon_general', 'options'); ?>" alt=""></a>
                    </div>
