...
<!-- 
<button id="getActiveSlide">Get Active Slide</button>

<button id="getActiveSection">Get Active Section</button>
 -->
<!-- 
<div id="fullpage">
    <div class="section" >
    ...
    <div class="section"  data-percentage="100">
...
There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handf
  ...
  <div  class="section " id="section0">
    ...
    <div data-percentage="100" class="section " id="section0">
...
<script scr="https://unpkg.com/fullpage.js/dist/fullpage.min.js"></script> -->
...
$(document).ready(function() {
			$('#fullpage').fullpage({
				...
				anchors: ['firstPage1', 'firstPage2', 'firstPage3', 'secondPage', '3rdPage', '4thpage', 'lastPage','reallyLastPage'],
				menu: '#menu',
				css3: true,
        scrollOverflow: true,
